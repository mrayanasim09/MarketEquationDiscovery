...
\title{Temporal Architecture or Trade Topology? A Prospective Ablation Study of Graph Neural Networks for Inflation Forecasting}
...
\subsection{2.5 Theoretical Motivation: Why Trade Networks Should Predict Inflation}\label{theoretical-motivation-why-trade-networks-should-predict-inflation}
...
\item
  ...
  ranks first in point MAE (2.358 pp), compared to ARIMA (2.433 pp). While
...
\item
  ...
  achieves the lowest point MAE (2.840 pp) compared to ARIMA (3.382 pp), a
